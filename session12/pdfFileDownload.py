...
def firefox_setup():
    ...
    ops.set_preference("browser.helperApps.neverAsk.saveToDisk", "application/pdf") # list of MIME types to save to disk without asking what to use to open the file
...
downloadBtn = driver.find_element(By.XPATH, "(//a[@class='btn btn-primary pull-right'][normalize-space()='Download'])[3]")
